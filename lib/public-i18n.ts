...
const basePublicMessages: Record<'fr' | 'en' | 'de' | 'es', PublicMessages> = {
  fr: {
...
export const publicMessages: Record<Language, PublicMessages> = {
  ...
  it: {
    ...
    login: {
      title: 'Acceda alla sua area',
      subtitle:
        'Acceda in modo sicuro ai suoi conti, saldi, bonifici e prestiti {bankName}.',
      ...
      submit: 'Accedi',
      submitting: 'Accesso…',
      newUser: 'Nuovo su {bankName}?',
      register: 'Crea un conto',
      genericError: 'Accesso non riuscito. Verifichi le sue credenziali.',
      errors: {
        auth_callback: 'Il link di accesso non è valido o è scaduto.',
        auth_confirmation: 'Il link di conferma non è valido o è scaduto.',
        configuration: 'La connessione a Supabase deve essere configurata durante la distribuzione.',
        session: 'La sua sessione è scaduta o è stata revocata. Acceda nuovamente.',
      },
    },
    register: {
      title: 'Crei il suo conto {bankName}',
      subtitle: 'Crei il suo accesso bancario protetto.',
      displayName: 'Nome completo',
      email: 'Indirizzo e-mail',
      baseCurrency: 'Valuta di base',
      password: 'Password',
      confirmPassword: 'Conferma password',
      displayNamePlaceholder: 'Nome e cognome',
      emailPlaceholder: 'lei@esempio.com',
      baseCurrencyPlaceholder: 'Scelga una valuta',
      baseCurrencyHint: 'Scelta definitiva per il suo conto principale.',
      passwordPlaceholder: 'Crei una password',
      confirmPasswordPlaceholder: 'Ripeta la password',
      passwordHint: '8–72 caratteri: maiuscola, minuscola, numero e simbolo, senza spazi.',
      showPassword: 'Mostra la password',
      hidePassword: 'Nascondi la password',
      submit: 'Crea un conto',
      submitting: 'Creazione del conto…',
      baseCurrencyRequiredError:
        'Selezioni una valuta per continuare la registrazione.',
      passwordPolicyError:
        'La password deve contenere da 8 a 72 caratteri, con una minuscola, una maiuscola, un numero e un simbolo, senza spazi.',
      passwordMismatchError: 'Le password non coincidono.',
      genericError: 'Non è stato possibile creare il conto.',
      checkEmailTitle: 'Confermi il suo indirizzo e-mail',
      checkEmailBody:
        'Se questo indirizzo può essere registrato, è stato inviato un codice di 6 cifre a {email}. Lo inserisca qui sotto. Nessun codice? Acceda oppure reimposti la password.',
      otpLabel: 'Codice ricevuto via e-mail',
      otpPlaceholder: '000000',
      otpHint: 'Non condivida mai questo codice.',
      otpSubmit: 'Conferma il mio indirizzo',
      otpSubmitting: 'Verifica…',
      otpInvalidError: 'Inserisca il codice di 6 cifre ricevuto via e-mail.',
      otpVerificationError: 'Il codice non è valido o è scaduto. Lo verifichi oppure ne richieda uno nuovo.',
      resendPrompt: 'Non ha ricevuto il codice?',
      resendAction: 'Invia di nuovo il codice',
      resending: 'Invio…',
      resendCooldown: 'Nuovo invio disponibile tra {seconds} s',
      resendSuccess: 'Se è possibile inviare un codice, l’invio è stato riavviato.',
      resendError: 'Non è stato possibile inviare nuovamente il codice. Riprovi tra qualche istante.',
      backToLogin: 'Torna all’accesso',
      resetAccess: 'Reimposta la mia password',
    },
    adminLogin: basePublicMessages.fr.adminLogin,
    resetPassword: {
      requestTitle: 'Reimposta la password',
      updateTitle: 'Scelga una nuova password',
      email: 'Indirizzo e-mail',
      password: 'Nuova password',
      confirmPassword: 'Conferma',
      emailPlaceholder: 'lei@esempio.com',
      passwordPlaceholder: 'Crei una nuova password',
      confirmPasswordPlaceholder: 'Confermi la nuova password',
      passwordHint:
        'Utilizzi da 8 a 72 caratteri con una minuscola, una maiuscola, un numero e un simbolo, senza spazi.',
      adminPasswordHint: basePublicMessages.fr.resetPassword.adminPasswordHint,
      showPassword: 'Mostra la password',
      hidePassword: 'Nascondi la password',
      requestSubmit: 'Invia il link protetto',
      updateSubmit: 'Salva',
      submitting: 'Elaborazione…',
      recoveryError:
        'Il link di recupero non è valido o è scaduto. Ne richieda uno nuovo.',
      passwordError:
        'Utilizzi da 8 a 72 caratteri con una minuscola, una maiuscola, un numero e un simbolo, senza spazi, e inserisca due valori identici.',
      adminPasswordError: basePublicMessages.fr.resetPassword.adminPasswordError,
      requestSuccess:
        'Se questo indirizzo esiste, è stato inviato un link protetto. Scadrà secondo la politica di Supabase Auth.',
      requestError: 'Non è stato possibile inviare la richiesta.',
      updateError: 'Non è stato possibile aggiornare la password.',
      backToLogin: 'Torna all’accesso',
    },
  },
  nl: {
    ...
    login: {
      title: 'Inloggen in uw omgeving',
      subtitle:
        'Krijg veilig toegang tot uw {bankName}-rekeningen, saldi, overschrijvingen en leningen.',
      email: 'E-mailadres',
      password: 'Wachtwoord',
      ...
      submit: 'Inloggen',
      submitting: 'Inloggen…',
      newUser: 'Nieuw bij {bankName}?',
      register: 'Een rekening openen',
      genericError: 'Inloggen mislukt. Controleer uw inloggegevens.',
      errors: {
        auth_callback: 'De inloglink is ongeldig of verlopen.',
        auth_confirmation: 'De bevestigingslink is ongeldig of verlopen.',
        configuration: 'De Supabase-verbinding moet tijdens de implementatie worden ingesteld.',
        session: 'Uw sessie is verlopen of ingetrokken. Log opnieuw in.',
      },
    },
    register: {
      title: 'Open uw {bankName}-rekening',
      subtitle: 'Maak uw beveiligde toegang tot de bankomgeving aan.',
      displayName: 'Volledige naam',
      email: 'E-mailadres',
      baseCurrency: 'Basisvaluta',
      password: 'Wachtwoord',
      confirmPassword: 'Wachtwoord bevestigen',
      displayNamePlaceholder: 'Voor- en achternaam',
      emailPlaceholder: 'u@voorbeeld.nl',
      baseCurrencyPlaceholder: 'Kies een valuta',
      baseCurrencyHint: 'Definitieve keuze voor uw hoofdrekening.',
      passwordPlaceholder: 'Maak een wachtwoord aan',
      confirmPasswordPlaceholder: 'Herhaal het wachtwoord',
      passwordHint: '8–72 tekens: hoofdletter, kleine letter, cijfer en symbool, zonder spaties.',
      showPassword: 'Wachtwoord tonen',
      hidePassword: 'Wachtwoord verbergen',
      submit: 'Een rekening openen',
      submitting: 'Rekening aanmaken…',
      baseCurrencyRequiredError:
        'Selecteer een valuta om verder te gaan met uw registratie.',
      passwordPolicyError:
        'Het wachtwoord moet 8 tot 72 tekens bevatten, met een kleine letter, hoofdletter, cijfer en symbool, zonder spaties.',
      passwordMismatchError: 'De wachtwoorden komen niet overeen.',
      genericError: 'De rekening kon niet worden aangemaakt.',
      checkEmailTitle: 'Bevestig uw e-mailadres',
      checkEmailBody:
        'Als dit adres kan worden geregistreerd, is een 6-cijferige code naar {email} verzonden. Vul deze hieronder in. Geen code? Log in of stel uw wachtwoord opnieuw in.',
      otpLabel: 'Code ontvangen per e-mail',
      otpPlaceholder: '000000',
      otpHint: 'Deel deze code nooit.',
      otpSubmit: 'Mijn adres bevestigen',
      otpSubmitting: 'Controleren…',
      otpInvalidError: 'Vul de 6-cijferige code uit de e-mail in.',
      otpVerificationError: 'Deze code is ongeldig of verlopen. Controleer de code of vraag een nieuwe aan.',
      resendPrompt: 'Hebt u de code niet ontvangen?',
      resendAction: 'Code opnieuw versturen',
      resending: 'Versturen…',
      resendCooldown: 'Opnieuw versturen mogelijk over {seconds} s',
      resendSuccess: 'Als een code kan worden verzonden, is de verzending opnieuw gestart.',
      resendError: 'De code kon niet opnieuw worden verzonden. Probeer het over enkele ogenblikken opnieuw.',
      backToLogin: 'Terug naar inloggen',
      resetAccess: 'Mijn wachtwoord opnieuw instellen',
    },
    adminLogin: basePublicMessages.fr.adminLogin,
    resetPassword: {
      ...
      confirmPassword: 'Bevestiging',
      emailPlaceholder: 'u@voorbeeld.nl',
      passwordPlaceholder: 'Maak een nieuw wachtwoord aan',
      confirmPasswordPlaceholder: 'Bevestig het nieuwe wachtwoord',
      passwordHint:
        'Gebruik 8 tot 72 tekens met een kleine letter, hoofdletter, cijfer en symbool, zonder spaties.',
      adminPasswordHint: basePublicMessages.fr.resetPassword.adminPasswordHint,
      showPassword: 'Wachtwoord tonen',
      hidePassword: 'Wachtwoord verbergen',
      requestSubmit: 'Beveiligde link versturen',
      updateSubmit: 'Opslaan',
      submitting: 'Verwerken…',
      recoveryError:
        'De herstellink is ongeldig of verlopen. Vraag een nieuwe link aan.',
      passwordError:
        'Gebruik 8 tot 72 tekens met een kleine letter, hoofdletter, cijfer en symbool, zonder spaties, en vul tweemaal dezelfde waarde in.',
      adminPasswordError: basePublicMessages.fr.resetPassword.adminPasswordError,
      requestSuccess:
        'Als dit adres bestaat, is een beveiligde link verzonden. Deze verloopt volgens het beleid van Supabase Auth.',
      requestError: 'Het verzoek kon niet worden verzonden.',
      updateError: 'Het wachtwoord kon niet worden bijgewerkt.',
      backToLogin: 'Terug naar inloggen',
    },
  },
};
