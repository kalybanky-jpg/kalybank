...
export default function AdminClientsView() {
  ...
  return (
    <div className="space-y-5">
      <header className="rounded-3xl bg-slate-900 p-5 text-white sm:p-6">
      ...
      >
        {selected && (
          <DialogBackdrop className="fixed inset-0 z-50 flex items-end bg-slate-950/60 p-0 sm:items-center sm:justify-center sm:p-4">
          <DialogPanel as="section" className="max-h-[92dvh] w-full overflow-y-auto rounded-t-3xl bg-white px-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] pt-5 shadow-2xl sm:max-w-lg sm:rounded-3xl sm:p-6">
            <div className="flex items-start justify-between gap-3">
